...
| [Pump.fun](./Pump.fun.md) | competitor | Dominant permissionless memecoin launchpad on Solana; >$150B cumulative volume, $987M all-time fees, 11.7M tokens launched |
| [DAOs.fun](./DAOs.fun.md) | competitor | Investment DAO launchpad with 7-day fair raise, 10% early redemption penalty, mandatory fund expiry (3mo-1yr), burn-to-redeem at expiry |
